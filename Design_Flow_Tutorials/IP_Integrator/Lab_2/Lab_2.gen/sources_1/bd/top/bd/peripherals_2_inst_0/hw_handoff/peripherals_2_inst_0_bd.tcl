...
################################################################
# This is a generated script based on design: peripherals_2_inst_0
#
...
# source peripherals_2_inst_0_script.tcl
...
set design_name peripherals_2_inst_0
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /opt/Vivado-Design-Tutorials/Design_Flow_Tutorials/IP_Integrator/Lab_2/Lab_2.srcs/sources_1/bd/peripherals_2/peripherals_2.bd $design_name
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLK_DOMAIN {top_clk_wiz_1_0_clk_out1} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_ports S_AXI2] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_ports S_AXI3] [get_bd_intf_pins axi_gpio_1/S_AXI]
  ...
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI3] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI2] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
