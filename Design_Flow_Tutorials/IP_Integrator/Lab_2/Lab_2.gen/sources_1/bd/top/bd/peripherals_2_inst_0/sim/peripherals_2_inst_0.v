...
//Command     : generate_target peripherals_2_inst_0.bd
//Design      : peripherals_2_inst_0
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "peripherals_2_inst_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=peripherals_2_inst_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=/opt/Vivado-Design-Tutorials/Design_Flow_Tutorials/IP_Integrator/Lab_2/Lab_2.srcs/sources_1/bd/peripherals_2/peripherals_2.bd,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "peripherals_2_inst_0.hwdef" *) 
